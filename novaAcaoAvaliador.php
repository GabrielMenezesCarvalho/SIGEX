  ...
  <script>
    ...
    images.forEach(image => {
      image.addEventListener('click', event => {
        ...
        <!-- Campos que devem ser exibidos apenas quando "Edital" for selecionado -->
        <div class="field" id="indicadores-sistematica" style="display: none;">
        ...
        <div class="field" id="plano-trabalho-coordenador" style="display: none;">
        ...
        <div class="field" id="plano-trabalho-discentes" style="display: none;">
